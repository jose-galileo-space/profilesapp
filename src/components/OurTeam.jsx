            ...
            <div className="section-card">
              <div className="section-content">
                ...
                <ul className="section-text">
                  <li>
                    Our team has built and operated spacecraft and imaging
                    systems at leading institutions, universities, and space
              ...
              <div className="section-content">
                ...
                <ul className="section-text">
                  ...
                  <li>
                    ...
                    <br />
                    Optical and systems engineering contributions to NASA’s
                    James Webb Space Telescope and other space science
                    observatories.
                  </li>
                  <li>
                    <b>Launch & Avionics</b>
                  ...
                  <li>
                    ...
                    and geospatial analytics platforms globally, bridging the
                    gap between advanced space technology and customer demand.
                  </li>
                </ul>
              </div>
            </div>
